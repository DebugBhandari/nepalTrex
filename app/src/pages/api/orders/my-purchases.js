...
export default async function handler(req, res) {
  ...
  try {
    const result = await query(
      `SELECT o.id, o.order_group_id, o.menu_item_name, o.menu_item_category, o.unit_price, o.quantity, o.total_price,
              o.customer_name, o.customer_email, o.customer_phone, o.notes, o.status, o.created_at,
              s.name AS stay_name, s.id AS stay_id
       FROM orders o
    ...
    for (const row of result.rows) {
      ...
      } else if (row.status === 'declined' && group.status !== 'completed') {
